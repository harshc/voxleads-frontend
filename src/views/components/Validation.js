                      ...
                      <Row>
                        <Col className="mb-4">
                          <div className="success">
                            ...
                            <p>We are pleased to confirm that we have received your order #[Order Number] placed on [Order Date]. Here are the details of your transaction:</p>
                            
                            <div className="order-summary mb-4">
                              <h4 className="heading-small mb-2">Order Summary</h4>
                            ...
                            <div className="payment-info mb-4">
                              <h4 className="heading-small mb-2">Payment Information</h4>
                            ...
                            <h4 className="heading-small">Thank you for using Vox Leads!</h4>
                          </div>
                        </Col>
                      </Row>
                      {/* ✅ Failed messages */}
                      <Row>
                        <Col className="mb-4">
                          <div className="failure">
                            ...
                            <p>Unfortunately, we were unable to process your payment for order #[Order Number].</p>
